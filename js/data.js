...
function initSaber(){
    initialServant(5,"Saber", "阿尔托莉雅", 2, "地", 11221, 15150, 12283, 16597, 3,1,0, "BusterAll2", 0, 0, "", 1.5, {attackBuff: [9,18]}, {cardBuff: [30,50]}, {}, [], {}, {}, {attackBuff: [9,18]});
...
/******************************************4星********************************************************************/
    ...
    initialServant(4,"Saber", "兰陵王", 227, "人", 9112, 12625, 11033, 15308, 0,0,0, "Null", 0, 0, "", 0, {}, {}, {}, [], {}, {}, {attackBuff: [10,20]}, {}, {cardBuff: [10,20,1]});
    ...
    initialServant(3,"Saber", "吉尔·德·雷", 9, "人", 6615, 10498, 8952, 14234, 0,0,0, "Null", 0, 0, "", 0, {}, {}, {}, [], {}, {}, {npStrength: [8,16]});
...
function initArcher(){
    ...
    initialServant(5,"Archer", "特斯拉", 77, "星", 11781, 13825, 12896, 15146, 3,1,0, "BusterAll2", 150, 200, "NpSpecialAttack", 1.5, {}, {attackBuff: [10,20], randomNpStrength: [20,30]}, {}, [], {}, {}, {npGainBuff: [20,30]});
    ...
    initialServant(5,"Archer", "莫里亚蒂SC", 156, "人", 11781, 13685, 12896, 14992, 1,1,0, "Null", 20, 40, "DefDecrease", 1.5, {}, {npStrength: [20,20]}, {attackBuff: [10,20]}, [], {}, {}, {}, {}, {attackBuff: [10,20], randomAttackBuff: [10,20]});
...
function initLancer(){
    ...
    initialServant(5,"Lancer", "阿尔托莉雅", 119, "天", 10995, 15606, 12036, 17097, 3,1,0, "BusterAll1", 0, 0, "", 1.5, {cardBuff: [30,50]}, {attackBuff: [9,18]}, {}, [], {}, {}, {}, {attackBuff: [9,18]});
    ...
    initialServant(5,"Lancer", "埃列什基伽勒", 196, "地", 10343, 16065, 11322, 17600, 3,1,0, "BusterAll1", 10, 50, "OcCardBuff", 1.5, {}, {cardBuff: [30,50]}, {}, [], {damagePlus: 225}, {}, {}, {}, {npGainBuff: [20,30]});
    ...
    initialServant(4,"Lancer", "巴托里EN", 18, "人", 9122, 11870, 11045, 14392, 3,1,0, "BusterAll1", 0, 0, "", 1.5, {attackBuff: [10,20]}, {defDecreaseSingle: [10,20]}, {}, [], {}, { ignoreDef: true });
    ...
    initialServant(4,"Lancer", "李书文SC", 102, "人", 9653, 11360, 11688, 13774, 1,3,0.52, "ArtsSingle1", 0, 0, "", 1, {}, {}, {cardBuff: [30,50]}, [12,25], {}, { ignoreDef: true });
    ...
    initialServant(4,"Lancer", "茨木童子", 217, "地", 9133, 12354, 11058, 14979, 1,1,0, "BusterSingle1", 0, 0, "", 1.5, {attackBuff: [10,20], npStrength: [20,30]}, {}, {}, [], {cardBuff: 4}, { ignoreDef: true }, {attackBuff: [10,20]});
    ...
    initialServant(3,"Lancer", "宝藏院胤舜", 186, "人", 6791, 9996, 9191, 13553, 0,0,0, "Null", 0, 0, "", 0, {}, {}, {}, [], {}, {}, {}, {}, {defDecreaseSingle: [10,20]});
    initialServant(2,"Lancer", "列奥尼达一世", 21, "人", 6583, 7959, 9539, 11486, 0,0,0, "Null", 0, 0, "", 0, {}, {}, {}, [], {}, {}, {}, {}, {cardBuff: [15,25,1.5]});
...
function initRider(){
    //----------------------------------Rider---------------------------------------------------------------------//
    /******************************************5星********************************************************************/
    initialServant(5,"Rider", "德雷克", 65, "星", 11326, 12830, 12398, 14056, 3,1,0, "BusterAll2", 0, 0, "", 1.5, {npStrength: [8.5,17], attackBuff: [8.5,17]}, {}, {}, [], {}, {}, {npStrength: [8.5,17], attackBuff: [8.5,17]});
    ...
    initialServant(4,"Rider", "玛尔达EN", 30, "人", 8014, 13068, 9703, 15845, 3,1,0, "BusterAll1", 0, 0, "", 1.5, {}, {}, {defDecreaseSingle: [10,30]}, [], {damagePlus: 150});
    ...
    initialServant(4,"Rider", "阿尔托莉雅〔圣诞Alter〕", 73, "人", 9258, 11286, 11209, 13684, 3,1,0, "BusterAll3", 0, 0, "", 1.5, {}, {}, {cardBuff: [25,45]});
    ...
    initialServant(3,"Rider", "哥伦布SC", 172, "人", 6552, 9600, 8867, 13016, 3,1,0, "BusterAll1", 0, 0, "", 1.5, {npStrength: [7,14], attackBuff: [7,14]}, {}, {cardBuff: [10,20]});
    ...
    initialServant(2,"Rider", "蒂奇TC", 25, "人", 6188, 7907, 8967, 11411, 3,1,0, "BusterAll1", 0, 0, "", 1.5, {npStrength: [8,16], attackBuff: [8,16]}, {attackBuff: [9,27]});
...
function initCaster(){
    //----------------------------------Caster---------------------------------------------------------------------//
    /******************************************5星********************************************************************/
    initialServant(5,"Caster", "诸葛孔明〔埃尔梅罗II世〕", 37, "人", 10598, 14259, 11601, 15621, 0,0,0, "Null", 0, 0, "", 0, {}, {}, {}, [], {}, {}, {}, {}, {attackBuff: [20,30], damagePlus: [200,500]});
    ...
    initialServant(5,"Caster", "达·芬奇", 127, "星", 10598, 14259, 11601, 15621, 3,1,0.54, "ArtsAll2", 30, 70, "OcNpStrength", 1, {randomNpStrength: [20,30]}, {}, {}, [], {cardBuff: 10}, { ignoreDef: true });
    initialServant(5,"Caster", "达·芬奇EN", 127, "星", 10598, 14259, 11601, 15621, 3,1,0.54, "ArtsAll1", 30, 70, "OcNpStrength", 1, {randomNpStrength: [20,30]}, {}, {}, [], {cardBuff: 10}, { ignoreDef: true });
    ...
    initialServant(5,"Caster", "尼禄", 175, "人", 10857, 13685, 11885, 14992, 3,1,0, "BusterAll1", 20, 60, "OcNpStrength", 1.5, {}, {attackBuff: [20,30]}, {attackBuff: [30,50]}, [], {}, {}, {}, {}, {attackBuff: [30,50]});
    ...
    initialServant(4,"Caster", "爱迪生", 103, "人", 7952, 11882, 9628, 14407, 3,1,0.51, "ArtsAll2", 0, 0, "", 1, {}, {}, {}, [], {cardBuff: 4});
    ...
    initialServant(4,"Caster", "吉尔伽美什", 145, "人", 8460, 12005, 10243, 14556, 3,10,0.16, "ArtsAll1", 0, 0, "", 1, {}, {attackBuff: [10.5,21]}, {cardBuff: [20,30]}, [1,3,5,7,9,10,12,14,16], {cardBuff: 10, damagePlus: 175}, {}, {}, {attackBuff: [10.5,21]}, {cardBuff: [20,30,1]});
    ...
    initialServant(3,"Caster", "帕拉塞尔苏斯TC", 79, "人", 6711, 9506, 9082, 12889, 3,3,0.55, "BusterAll2", 0, 0, "", 1, {}, {cardBuff: [10,20]}, {}, [16,33], {cardBuff: 10}, {}, {}, {cardBuff: [10,20,1]});
    initialServant(3,"Caster", "巴贝奇", 80, "人", 5996, 10887, 8115, 14761, 3,1,0, "BusterAll2", 0, 0, "", 1.5, {}, {attackBuff: [20,40]}, {npStrength: [15,25]});
    ...
    initialServant(1,"Caster", "莫扎特", 36, 5195, 7129, 8072, 10990, 0,0,0, "Null", 0, 0, "", 0, {}, {}, {}, [], {}, {}, {cardBuff: [22,44,1]});
}
...
function initAssassin(){
    ...
    initialServant(5,"Assassin", "塞弥拉弥斯SC", 199, "地", 11309, 13266, 12379, 14533, 3,1,0, "BusterAll1", 10, 50, "OcNpStrength", 1.5, {}, {}, {cardDecreaseAll: [30,50]}, [], {damagePlus: 150}, { resistClass: ["Caster",1] });
    ...
    /******************************************4星********************************************************************/
    initialServant(4,"Assassin", "斯忒诺", 41, "天", 8985, 11518, 10879, 13965, 0,0,0, "Null", 0, 0, "", 0, {}, {}, {}, [], {}, {}, {}, {}, {attackBuff: [10,20], randomAttackBuff: [10,20]});
...
function initBerserker(){
    ...
    initialServant(5,"Berserker", "南丁格尔", 97, "人", 10184, 15221, 11148, 16675, 0,0,0, "Null", 0, 0, "", 0, {}, {}, {}, [], {}, {}, {}, {}, {cardBuff: [30,50,1.5]});
    ...
    initialServant(4,"Berserker", "贞德〔Alter〕", 219, "人", 10298, 9922, 12469, 12030, 1,1,0, "BusterSingle1", 0, 0, "", 1.5, {}, {attackBuff: [10,20]}, {cardBuff: [10,20]}, [], {cardBuff: 12});
    /******************************************3星及以下********************************************************************/
...
//----------------------------------Shielder---------------------------------------------------------------------//
    ...
    initialServant(5,"Ruler", "阿尔托莉雅", 265, "天", 9593, 16912, 10501, 18528, 3,1,0, "BusterAll1", 20, 40, "OcCardBuff", 1.5, {attackBuff: [20,30]}, {}, {attackBuff: [20,40]}, [], {}, { ignoreDef: true });
    /******************************************4星********************************************************************/
    ...
    initialServant(5,"Avenger", "岩窟王TC", 96, "人", 12641, 12177, 13838, 13340, 3,8,0.62, "BusterSingle1", 0, 0, "", 0.8, {attackBuff: [30,50]}, {npGainBuff: [20,50]}, {}, [3,6,10,13,16,13,10], {chargeNp: 3});
    ...
    initialServant(5,"Avenger", "织田信长", 250, "地", 12641, 11761, 13838, 12885, 3,1,0, "BusterAll1", 150, 200, "NpSpecialAttack", 1.5, {attackBuff: [20,30], accAttackBuff: [10,20]}, {}, {}, [], {}, { specialNullifyDef: true });
    ...
    initialServant(5,"Avenger", "宇宙伊什塔尔〔Buster〕", 268, "星", 12612, 13041, 13806, 14287, 3,1,0, "BusterAll1", 20, 60, "OcNpStrength", 1.5, {attackBuff: [10,20]}, {npStrength: [10,20]}, {randomCardBuff: [20,20]}, [], {damagePlus: 270});
    ...
    initialServant(5,"Alterego", "Meltryllis EN", 163, "地", 11692, 13402, 12799, 14682, 1,8,0.92, "QuickSingle1", 0, 0, "", 0.8, {}, {attackBuff: [10,30]}, {npStrength: [20,20]}, [2,5,8,11,13,16,19], {cardBuff: 8, damagePlus: 225});
    ...
    initialServant(4,"Alterego", "Passionlip SC", 164, "地", 10299, 10901, 12470, 13217, 3,1,0, "BusterAll1", 0, 0, "", 1.5, {}, {}, {attackBuff: [10,30]}, [], {damagePlus: 200});
