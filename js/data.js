...
function initAssassin(){
    ...
    initialServant(5,"Assassin", "克娄巴特拉TC", 139, "人", 11088, 13402, 12138, 14682, 3,1,0, "BusterAll1", 30, 70, "OcCardBuff", 1.5, {randomAttackBuff: [20,40]}, {npGainBuff: [20,40], chargeNp: [10,10]}, {}, [], {damagePlus: 125});
...
function initBerserker(){
    ...
    initialServant(4,"Berserker", "织田信长", 178, "人", 10146, 10023, 12285, 12153,1,1,0, "BusterSingle1", 150, 200, "NpSpecialAttack", 1.5, {cardBuff: [10,20]}, {chargeNp: [3,3]}, {randomAttackBuff: [10,20]}, [], {cardBuff: 6});
...
//----------------------------------Shielder---------------------------------------------------------------------//
    ...
    initialServant(5,"Ruler", "阿尔托莉雅", 265, "天", 9593, 16912, 10501, 18528, 3,1,0, "BusterAll1", 20, 40, "OcCardBuff", 1.5, {attackBuff: [20,30]}, {}, {attackBuff: [20,40]}, [], {}, { ignoreDef: true, chargeNp: 20 });
    /******************************************4星********************************************************************/
    ...
    initialServant(5,"Avenger", "织田信长", 250, "地", 12641, 11761, 13838, 12885, 3,1,0, "BusterAll1", 150, 200, "NpSpecialAttack", 1.5, {attackBuff: [20,30], accAttackBuff: [10,20]}, {}, {chargeNp: [10,20]}, [], {chargeNp: 3.3}, { specialNullifyDef: true });
