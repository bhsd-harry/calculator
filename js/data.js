...
function initSaber(){
    ...
    initialServant(5,"Saber", "两仪式WW", "Ryougi Shiki（Saber)", 91, [], "人", ["中立", "中庸"], [], 10721, 15453, 11736, 16929, "AABBQ", 450, 600, 675, 712.5, 750, 0, 0, 0, 0, 0, "", 1, { cardColor: 0, cardBuff: 6, fixedDamageBuff: 0, critialPowerBuff: 6 });
    initialServant(5,"Saber", "宫本武藏", "Miyamoto Musashi", 153, [], "人", ["混沌", "善"], [], 12037, 13635, 13176, 14938, "ABBBQ", 600, 800, 900, 950, 1000, 20, 30, 40, 50, 60, "TreasurePowerBuff", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
...
/******************************************4星********************************************************************/
    initialServant(4,"Saber", "阿尔托莉雅·潘德拉贡〔Alter〕", "Altria Pendragon（Alter)", 3, [], "人", ["秩序", "恶"], [], 10248, 11589, 12408, 14051, "AABBQ", 450, 550, 600, 625, 650, 0, 0, 0, 0, 0, "", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Saber", "阿尔托莉雅·潘德拉贡〔Lily〕WW", "Altria Pendragon（Lily)", 4, [], "地", ["秩序", "善"], [], 7726, 10623, 9355, 12880, "AABBQ", 300, 450, 525, 562.5, 600, 0, 0, 0, 0, 0, "", 1.5, { cardColor: 0.8, cardBuff: 6, fixedDamageBuff: 0, critialPowerBuff: 0 });
...
function initArcher(){
    ...
    initialServant(5,"Archer", "伊修塔尔WW", "Ishtar", 142, [], "天", ["秩序", "善"], [], 12252, 13965, 13412, 15299, "AABBQ", 300, 400, 450, 475, 500, 20, 30, 40, 50, 60, "TreasureSpecialCardPowerAttack", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 225, critialPowerBuff: 10 });
    ...
    initialServant(4,"Archer", "特里斯坦WW", "Tristan", 122, [], "地", ["秩序", "善"], [], 9735, 11637, 11787, 14110, "AABQQ", 1200, 1600, 1800, 1900, 2000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 8 });
    ...
    initialServant(4,"Archer", "卫宫〔Alter〕WW", "Emiya〔Alter〕", 157, [], "人", ["混沌", "恶"], [], 8996, 12250, 10892, 14853, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 10 });
    ...
    initialServant(3,"Archer", "俵藤太WW", "Tawara Toda", 125, [], "人", ["中立", "善"], [], 7032, 9800, 9517, 13287, "AABBQ", 300, 400, 450, 475, 500, 50, 62.5, 75, 87.5, 100, "SpecialAttackPowerBuff", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 8 });
...
function initLancer(){
    //----------------------------------Lancer---------------------------------------------------------------------//
    /******************************************5星********************************************************************/
    initialServant(5,"Lancer", "斯卡哈", "Scathach", 70, [], "星", ["秩序", "善"], [], 11375, 14825, 12452, 16241, "ABBQQ", 1600, 2000, 2200, 2300, 2400, 0, 0, 0, 0, 0, "", 0.8, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Lancer", "伊丽莎白・巴陶里WW", "Erzsebet Bathory", 18, [], "人", ["混沌", "恶"], [], 9122, 11870, 11045, 14392, "ABBQQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: 1, cardBuff: 8, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Lancer", "神枪 李书文", "Li Shu Wen", 102, [], "人", ["中立", "恶"], [], 9653, 11360, 11688, 13774, "AABQQ", 1200, 1500, 1650, 1725, 1800, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(4,"Lancer", "神枪 李书文WW", "Li Shu Wen", 102, [], "人", ["中立", "恶"], [], 9653, 11360, 11688, 13774, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Lancer", "弗拉德三世〔Extra〕", "Vlad III(Extra)", 140, [], "人", ["秩序", "善"], [], 8775, 13005, 10625, 15769, "ABBQQ", 600, 800, 900, 950, 1000, 150, 162.5, 175, 187.5, 200, "TreasureSpecialAttack", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(4,"Lancer", "贞德・Alter・Santa・Lily", "Jeanne d'Arc・Alter・Santa・Lily", 141, [], "人", ["混沌", "善"], [], 9261, 11870, 11213, 14392, "ABBQQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Lancer", "美杜莎〔Lancer〕WW", "Medusa(Lancer)", 146, [], "地", ["中立", "善"], [], 8253, 13119, 9993, 15907, "AABQQ", 1200, 1600, 1800, 1900, 2000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 250, critialPowerBuff: 0 });
    ...
    initialServant(4,"Lancer", "哪吒", "Nezha", 193, [], "天", ["中立", "善"], [], 9284, 12112, 11241, 14686, "ABBQQ", 300, 400, 450, 475, 500, 20, 30, 40, 50, 60, "TreasurePowerBuff", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(3,"Lancer", "库・丘林WW", "Cu Chulainn", 17, [], "天", ["秩序", "中庸"], [], 7239, 9593, 9797, 13007, "ABBQQ", 1200, 1600, 1800, 1900, 2000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 175, critialPowerBuff: 0 });
    ...
    initialServant(3,"Lancer", "罗穆路斯", "Romulus", 22, [], "星", ["混沌", "中立"], [], 7239, 9883, 9797, 13400, "ABBQQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(3,"Lancer", "迪尔姆德・奥迪纳", "Diarmuid Ua Duibhne", 71, [], "地", ["秩序", "中庸"], [], 6877, 10098, 9307, 13691, "AABQQ", 1600, 2000, 2200, 2300, 2400, 0, 0, 0, 0, 0, "", 0.8, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
...
function initRider(){
    ...
    initialServant(4,"Rider", "玛丽・安托瓦内特WW", "Marie Antoinette", 29, [], "人", ["秩序", "善"], [], 8293, 12348, 10041, 14972, "AABQQ", 600, 800, 900, 950, 1000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: 0.8, cardBuff: 11, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Rider", "马大WW", "Marthe", 30, [], "人", ["秩序", "善"], [], 8014, 13068, 9703, 15845, "AAABQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: 0.8, cardBuff: 11.5, fixedDamageBuff: 150, critialPowerBuff: 0 });
    initialServant(4,"Rider", "安妮・伯妮&玛丽・里德", "Anne Bonny&Mary Read", 66, [], "人", ["混沌", "恶"], [], 9029, 11286, 10932, 13684, "AABQQ", 1600, 2000, 2200, 2300, 2400, 1200, 1400, 1600, 1800, 2000, "TreasureSpecialRemainHpAttack", 0.8, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(3,"Rider", "美杜莎WW", "Medusa", 23, [], "地", ["混沌", "善"], [], 7200, 8937, 9744, 12117, "AABQQ", 600, 800, 900, 950, 1000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: 0.8, cardBuff: 11, fixedDamageBuff: 95, critialPowerBuff: 6 });
    ...
    initialServant(3,"Rider", "克里斯托弗·哥伦布WW", "Cristoforo Colombo", 172, [], "人", ["中立", "恶"], [], 6552, 9600, 8867, 13016, "AABBQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: 0.8, cardBuff: 8, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(2,"Rider", "爱德华・蒂奇", "Edward Teach", 25, [], "人", ["混沌", "恶"], [], 6188, 7907, 8967, 11411, "AABBQ", 400, 500, 550, 575, 600, 0, 0, 0, 0, 0, "", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(2,"Rider", "爱德华・蒂奇WW", "Edward Teach", 25, [], "人", ["混沌", "恶"], [], 6188, 7907, 8967, 11411, "AABBQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
...
function initCaster(){
    ...
    initialServant(5,"Caster", "莱昂纳多・达・芬奇WW", "Leonardo da Vinci", 127, [], "星", ["混沌", "善"], [], 10598, 14259, 11601, 15621, "AAABQ", 450, 600, 675, 712.5, 750, 30, 40, 50, 60, 70, "TreasurePowerBuff", 1, { cardColor: 1, cardBuff: 10, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(5,"Caster", "伊莉雅斯菲尔", "Illyasviel", 136, [], "人", ["中立", "善"], [], 10857, 13825, 11885, 15146, "AAABQ", 800, 1000, 1100, 1150, 1200, 20, 40, 60, 80, 100, "TreasureSpecialCardPowerAttack", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(5,"Caster", "山鲁佐德WW", "Scheherazade", 169, [], "人", ["秩序", "中庸"], [], 9212, 15846, 10084, 17360, "AAABQ", 450, 600, 675, 712.5, 750, 200, 225, 250, 275, 300, "TreasureSpecialAttack", 1, { cardColor: 1, cardBuff: 11.5, fixedDamageBuff: 0, critialPowerBuff: 0 }, { treasurePowerBuff: 20 });
    ...
    initialServant(3,"Caster", "库・丘林WW", "Cu Chulainn2", 38, [], "天",["秩序","中庸"],[], 6580, 9604, 8905, 13022, "AAABQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: 1, cardBuff: 8, fixedDamageBuff: 175, critialPowerBuff: 0 });
    ...
    initialServant(3,"Caster", "查尔斯・巴贝奇", "Charles Babbage", 80, [], "人",["混沌","中庸"],[], 5996, 10887, 8115, 14761, "AABBQ", 400, 500, 550, 575, 600, 0, 0, 0, 0, 0, "", 1.5,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
...
function initAss(){
    //----------------------------------Assassin---------------------------------------------------------------------//
    /******************************************5星********************************************************************/
    initialServant(5,"Assassin", "开膛手杰克", "Jack the Ripper", 75, [], "地",["混沌","恶"],[], 11557, 12696, 12651, 13909, "ABQQQ", 1400, 1800, 2000, 2100, 2200, 50, 62.5, 75, 87.5, 100, "SpecialAttackPowerBuff", 0.8,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(5,"Assassin", "酒吞童子WW", "Shuten Doji", 112, [], "地",["混沌","恶"],[], 11993, 12825, 13128, 14050, "AABQQ", 450, 600, 675, 712.5, 750, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 150, critialPowerBuff: 0 });
    ...
    initialServant(5,"Assassin", "克利奥帕特拉WW", "Cleopatra", 139, [], "人",["秩序","中庸"],[], 11088, 13402, 12138, 14682, "ABBQQ", 300, 400, 450, 475, 500, 30, 40, 50, 60, 70, "TreasureSpecialCardPowerAttack", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 125, critialPowerBuff: 0 });
    ...
    initialServant(5,"Assassin", "賽米拉米斯", "Semiramis", 199, [], "地",["秩序","惡"],[], 11309, 13266, 12379, 14533, "AAABQ", 400, 500, 550, 575, 600, 10, 20, 30, 40, 50, "TreasurePowerBuff", 1.5, { cardColor: 1, cardBuff: 12, fixedDamageBuff: 150, critialPowerBuff: 0 });
    initialServant(5,"Assassin", "賽米拉米斯WW", "Semiramis", 199, [], "地",["秩序","惡"],[], 11309, 13266, 12379, 14533, "AAABQ", 300, 400, 450, 475, 500, 10, 20, 30, 40, 50, "TreasurePowerBuff", 1.5, { cardColor: 1, cardBuff: 12, fixedDamageBuff: 150, critialPowerBuff: 0 });
    initialServant(5,"Assassin", "李书文","Li Shuwen2", 235, [], "人",["中立","恶"],[], 11470, 12568, 12556, 13769, "AABBQ", 900, 1200, 1350, 1425, 1500, 20, 25, 30, 35, 40, "TreasureSpecialDefReduceAttck", 1, { cardColor: 1, cardBuff: 8, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(5,"Assassin", "伽摩", "", 239, [], "天",["混沌","恶"],[], 11528, 12889, 12619, 14120, "ABBQQ", 1200, 1600, 1800, 1900, 2000, 20, 25, 30, 35, 40, "TreasureSpecialCardPowerAttack", 0.8, { cardColor: 0.8, cardBuff: 10, fixedDamageBuff: 225, critialPowerBuff: 6 });
    /******************************************4星********************************************************************/
    initialServant(4,"Assassin", "卡米拉", "Carmilla", 46, [], "地",["混沌","恶"],[], 9408, 10473, 11391, 12698, "ABQQQ", 800, 1000, 1100, 1150, 1200, 150, 162.5, 175, 187.5, 200, "TreasureSpecialAttack", 1.5,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(4,"Assassin", "卡米拉WW", "Carmilla", 46, [], "地",["混沌","恶"],[], 9408, 10473, 11391, 12698, "ABQQQ", 600, 800, 900, 950, 1000, 120, 132.5, 145, 157.5, 170, "TreasureSpecialAttack", 1.5,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(4,"Assassin", "两仪式〔Assassin〕", "Ryougi Shiki（Assassin)", 92, [], "人",["混沌","善"],[], 8867, 11055, 10736, 13404, "AABQQ", 1200, 1500, 1650, 1725, 1800, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 10 });
    initialServant(4,"Assassin", "两仪式WW", "Ryougi Shiki（Assassin)", 92, [], "人",["混沌","善"],[], 8867, 11055, 10736, 13404, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 10 });
    initialServant(4,"Assassin", "卫宫〔Assassin〕", "Emiya（Assassin)", 109, [], "人",["混沌","恶"],[], 8958, 11168, 10846, 13541, "AABQQ", 1200, 1500, 1650, 1725, 1800, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 10 });
    initialServant(4,"Assassin", "卫宫〔Assassin〕WW", "Emiya（Assassin)", 109, [], "人",["混沌","恶"],[], 8958, 11168, 10846, 13541, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 10 });
    initialServant(4,"Assassin", "斯卡哈", "Scathach2", 133, [], "星",["中立","善"],[], 9049, 11168, 10956, 13541, "ABQQQ", 600, 800, 900, 950, 1000, 0, 0, 0, 0, 0, "", 0.8,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Assassin", "武则天", "Wu Ze Tian", 170, [], "人",["秩序","恶"],[], 8981, 10942, 10874, 13267, "ABBQQ", 1600, 2000, 2200, 2300, 2400, 0, 0, 0, 0, 0, "", 0.8,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(4,"Assassin", "武则天WW", "Wu Ze Tian", 170, [], "人",["秩序","恶"],[], 8981, 10942, 10874, 13267, "ABBQQ", 1200, 1600, 1800, 1900, 2000, 0, 0, 0, 0, 0, "", 0.8,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Assassin", "望月千代女", "Mochizuki Chiyome", 185, [], "地",["混沌","恶"],[], 8510, 11637, 10304, 14110, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(4,"Assassin", "加藤段藏", "Katou Danzou", 188, [], "地",["中立","中庸"],[], 8935, 11055, 10818, 13404, "ABBQQ", 300, 400, 450, 475, 500, 150, 162.5, 175, 187.5, 200, "TreasureSpecialAttack", 1.5,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Assassin", "虞美人", "Consort Yu", 230, [], "地",["秩序","恶"],[], 7970, 13389, 9650, 16234, "ABBQQ", 300, 400, 450, 475, 500, 50, 62.5, 75, 87.5, 100, "TreasureSpecialCardPowerAttack", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Assassin", "沖田總司", "", 267, [], "人",["中立","夏"],[], 9337, 10366, 11305, 12569, "ABQQQ", 600, 800, 900, 950, 1000,0, 0, 0, 0, 0, "", 0.8,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    /******************************************3星及以下********************************************************************/
    initialServant(3,"Assassin", "荆轲", "Jing Ke", 42, [], "人",["混沌","善"],[], 7207, 8293, 9754, 11244, "ABQQQ", 1600, 2000, 2200, 2300, 2400, 0, 0, 0, 0, 0, "", 0.8,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(3,"Assassin", "百貌的哈桑", "Hassan of Hundred Faces", 110, [], "人",["秩序","恶"],[], 6686, 9310, 9049, 12623, "AABQQ", 1200, 1500, 1650, 1725, 1800, 0, 0, 0, 0, 0, "", 1,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(3,"Assassin", "百貌的哈桑WW", "Hassan of Hundred Faces", 110, [], "人",["秩序","恶"],[], 6686, 9310, 9049, 12623, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(3,"Assassin", "风魔小太郎", "Fuuma Koutarou", 117, [], "人",["混沌","恶"],[], 7091, 8844, 9597, 11991, "ABQQQ", 800, 1000, 1100, 1150, 1200, 0, 0, 0, 0, 0, "", 0.8,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(3,"Assassin", "风魔小太郎WW", "Fuuma Koutarou", 117, [], "人",["混沌","恶"],[], 7091, 8844, 9597, 11991, "ABQQQ", 600, 800, 900, 950, 1000, 0, 0, 0, 0, 0, "", 0.8,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(3,"Assassin", "静谧的哈桑", "Hassan of Serenity", 124, [], "人",["秩序","恶"],[], 6636, 9310, 8981, 12623, "AABQQ", 1200, 1500, 1650, 1725, 1800, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 10 });
    initialServant(3,"Assassin", "静谧的哈桑WW", "Hassan of Serenity", 124, [], "人",["秩序","恶"],[], 6636, 9310, 8981, 12623, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 10 });
    initialServant(3,"Assasin", "冈田以藏", "Izou Okada", 210, [], "人",["中立", "恶"],[], 6879, 8844, 9310, 11991, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(1,"Assassin", "佐佐木小次郎WW", "Sasaki Koujirou", 39, [], "人",["中立","恶"],[], 5735, 6220, 8912, 9588, "ABQQQ", 1200, 1600, 1800, 1900, 2000, 0, 0, 0, 0, 0, "", 0.8,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
...
function initBerserker(){
    ...
    initialServant(5,"Berserker", "土方岁三WW", "Hijikata Toshizou", 161, [], "人",["秩序","恶"],[], 12089, 12028, 13233, 13177, "ABBQQ", 600, 800, 900, 950, 1000, 600, 700, 800, 900, 1000, "TreasureSpecialRemainHpAttack", 1.5, { cardColor: 1.5, cardBuff: 5, fixedDamageBuff: 0, critialPowerBuff: 0 });
...
//----------------------------------Shielder---------------------------------------------------------------------//
    ...
    //----------------------------------Ruler---------------------------------------------------------------------//
    /******************************************5星********************************************************************/
    initialServant(5,"Ruler", "天草四郎", "Shirou Kotomine", 93, [], "人",["秩序","善"],[], 10972, 14107, 12011, 15455, "AABBQ", 400, 500, 550, 575, 600, 0, 0, 0, 0, 0, "", 1.5,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    /******************************************4星********************************************************************/
    initialServant(4,"Ruler", "马大", "Marthe2", 135, [], "人",["秩序","善"],[], 9546, 11250, 11558, 13640, "ABBBQ", 800, 1000, 1100, 1150, 1200, 20, 30, 40, 50, 60, "TreasureSpecialDefReduceAttck", 1.5,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(4,"Ruler", "马大WW", "Marthe2", 135, [], "人",["秩序","善"],[], 9546, 11250, 11558, 13640, "ABBBQ", 600, 800, 900, 950, 1000, 10, 20, 30, 40, 50, "TreasureSpecialDefReduceAttck", 1.5,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(5,"Avenger", "岩窟王 爱德蒙・唐泰斯WW", "Edmond Dantes", 96, [], "人",["混沌","恶"],[], 12641, 12177, 13838, 13340, "ABBQQ", 600, 800, 900, 950, 1000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 8 });
    ...
    initialServant(4,"Avenger", "戈尔贡WW", "Gorgon", 147, [], "地",["混沌","恶"],[], 10706, 10197, 12963, 12364, "AABBQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 6 });
    ...
    initialServant(4,"Avenger", "海森・罗伯WW", "Hyesons Robert", 158, [], "地",["混沌","恶"],[], 10628, 9949, 12868, 12063, "AABQQ", 1200, 1600, 1800, 1900, 2000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 8 });
    /******************************************3星及以下********************************************************************/
    ...
    initialServant(5,"Alterego", "帝王花", "Kingprotea", 238, [], "地",["秩序","善"],[], 12835, 13338, 14050, 14612, "AABBQ", 300, 400, 450, 475, 500, 40, 50, 60, 70, 80, "TreasureSpecialCardPowerAttack", 1.5, { cardColor: -4, cardBuff: "11|12", fixedDamageBuff: 250, critialPowerBuff: 8 });
    /******************************************4星********************************************************************/
    ...
    initialServant(4,"Alterego", "帕森莉普（热情迷唇）WW", "Passionlip", 164, [], "地",["秩序","中庸"],[], 10299, 10901, 12470, 13217, "ABBBQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 200, critialPowerBuff: 6 });
    initialServant(4,"Alterego", "机械伊丽酱", "mekaerichan", 190, [], "人",["秩序","善"],[], 9997, 10901, 12104, 13217, "ABBBQ", 600, 800, 900, 950, 1000, 0, 0, 0, 0, 0, "", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
