...
/******************************************4星********************************************************************/
    ...
    initialServant(3,"Saber", "贝狄威尔EN", "Bedwyr", 126, [], "星", ["秩序", "善"], [], 7627, 9595, 10322, 13009, "ABBQQ", 600, 800, 900, 950, 1000, 30, 40, 50, 60, 70, "TreasureSpecialCardPowerAttack", 1.5, { cardColor: 0.8, cardBuff: 10, fixedDamageBuff: 0, critialPowerBuff: 0 });
...
function initArcher(){
    ...
    initialServant(4,"Archer", "特里斯坦EN", "Tristan", 122, [], "地", ["秩序", "善"], [], 9735, 11637, 11787, 14110, "AABQQ", 1200, 1600, 1800, 1900, 2000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 8 });
    ...
    initialServant(3,"Archer", "俵藤太EN", "Tawara Toda", 125, [], "人", ["中立", "善"], [], 7032, 9800, 9517, 13287, "AABBQ", 300, 400, 450, 475, 500, 50, 62.5, 75, 87.5, 100, "SpecialAttackPowerBuff", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 8 });
...
function initLancer(){
    ...
    initialServant(4,"Lancer", "美杜莎〔Lancer〕EN", "Medusa(Lancer)", 146, [], "地", ["中立", "善"], [], 8253, 13119, 9993, 15907, "AABQQ", 1200, 1600, 1800, 1900, 2000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 250, critialPowerBuff: 0 });
...
function initAss(){
    ...
    initialServant(4,"Assassin", "卫宫〔Assassin〕EN", "Emiya（Assassin)", 109, [], "人",["混沌","恶"],[], 8958, 11168, 10846, 13541, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 10 });
    ...
    initialServant(3,"Assassin", "百貌的哈桑EN", "Hassan of Hundred Faces", 110, [], "人",["秩序","恶"],[], 6686, 9310, 9049, 12623, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(3,"Assassin", "风魔小太郎EN", "Fuuma Koutarou", 117, [], "人",["混沌","恶"],[], 7091, 8844, 9597, 11991, "ABQQQ", 600, 800, 900, 950, 1000, 0, 0, 0, 0, 0, "", 0.8,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(3,"Assassin", "静谧的哈桑EN", "Hassan of Serenity", 124, [], "人",["秩序","恶"],[], 6636, 9310, 8981, 12623, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 10 });
