...
function initSaber(){
    ...
    initialServant(5,"Saber", "两仪式EN", "Ryougi Shiki（Saber)", 91, [], "人", ["中立", "中庸"], [], 10721, 15453, 11736, 16929, "AABBQ", 450, 600, 675, 712.5, 750, 0, 0, 0, 0, 0, "", 1, { cardColor: 0, cardBuff: 6, fixedDamageBuff: 0, critialPowerBuff: 6 });
    ...
    initialServant(5,"Saber", "阿斯托尔福", "", 270, [], "地", ["混沌", "善"], [], 11694, 14248, 12801, 15609, "AABQQ", 1200, 1600, 1800, 1900, 2000, 20, 25, 30, 35, 40, "TreasureSpecialCardPowerAttack", 0.8, { cardColor: 0.8, cardBuff: 10, fixedDamageBuff: 0, critialPowerBuff: 0 });
/******************************************4星********************************************************************/
    ...
    initialServant(4,"Saber", "阿尔托莉雅·潘德拉贡〔Lily〕EN", "Altria Pendragon（Lily)", 4, [], "地", ["秩序", "善"], [], 7726, 10623, 9355, 12880, "AABBQ", 300, 450, 525, 562.5, 600, 0, 0, 0, 0, 0, "", 1.5, { cardColor: 0.8, cardBuff: 6, fixedDamageBuff: 0, critialPowerBuff: 0 });
...
function initArcher(){
    ...
    initialServant(5,"Archer", "伊修塔尔EN", "Ishtar", 142, [], "天", ["秩序", "善"], [], 12252, 13965, 13412, 15299, "AABBQ", 300, 400, 450, 475, 500, 20, 30, 40, 50, 60, "TreasureSpecialCardPowerAttack", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 225, critialPowerBuff: 10 });
    ...
    initialServant(5,"Archer", "拿破仑", "Napoleon", 212, [], "星", ["中立", "善"], [], 12033, 13097, 13172, 14348, "AABBQ", 400, 500, 550, 575, 600, 150, 162.5, 175, 187.5, 200, "TreasureSpecialAttack", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff:6});
    initialServant(5,"Archer", "拿破仑EN", "Napoleon", 212, [], "星", ["中立", "善"], [], 12033, 13097, 13172, 14348, "AABBQ", 300, 400, 450, 475, 500, 150, 162.5, 175, 187.5, 200, "TreasureSpecialAttack", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff:6});
    ...
    initialServant(4,"Archer", "卫宫〔Alter〕EN", "Emiya〔Alter〕", 157, [], "人", ["混沌", "恶"], [], 8996, 12250, 10892, 14853, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 10 });
    ...
    initialServant(4,"Archer", "巴御前", "Tomoe Gozen", 184, [], "地", ["中立", "中庸"], [], 9946, 10804, 12043, 13100, "AABBQ", 800, 1000, 1100, 1150, 1200, 0, 0, 0, 0, 0, "", 1.5, { cardColor:1.5, cardBuff: 2, fixedDamageBuff: 0, critialPowerBuff: 10 });
    initialServant(4,"Archer", "巴御前EN", "Tomoe Gozen", 184, [], "地", ["中立", "中庸"], [], 9946, 10804, 12043, 13100, "AABBQ", 600, 800, 900, 950, 1000, 0, 0, 0, 0, 0, "", 1.5, { cardColor:1.5, cardBuff: 2, fixedDamageBuff: 0, critialPowerBuff: 10 });
    ...
    initialServant(4,"Archer", "南丁格尔（圣诞）", "", 271, [], "人", ["秩序", "善"], [], 9859, 11080, 11936, 13434, "AABQQ", 600, 800, 900, 950, 1000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: 1.5, cardBuff: 12, fixedDamageBuff: 0, critialPowerBuff: 11 });
    /******************************************3星及以下********************************************************************/
...
function initLancer(){
    ...
    initialServant(5,"Lancer", "恩奇都EN", "Enkidu", 143, [], "天", ["中立", "中庸"], [], 10780, 15300, 11800, 16762, "ABQQQ", 600, 800, 900, 950, 1000, 20, 25, 30, 35, 40, "TreasureSpecialDefReduceAttck", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Lancer", "伊丽莎白・巴陶里EN", "Erzsebet Bathory", 18, [], "人", ["混沌", "恶"], [], 9122, 11870, 11045, 14392, "ABBQQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: 1, cardBuff: 8, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Lancer", "神枪 李书文EN", "Li Shu Wen", 102, [], "人", ["中立", "恶"], [], 9653, 11360, 11688, 13774, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(3,"Lancer", "库・丘林EN", "Cu Chulainn", 17, [], "天", ["秩序", "中庸"], [], 7239, 9593, 9797, 13007, "ABBQQ", 1200, 1600, 1800, 1900, 2000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 175, critialPowerBuff: 0 });
...
function initRider(){
    ...
    initialServant(5,"Rider", "伊凡雷帝", "Иван Грозный", 205, [], "人", ["秩序", "恶"], [], 11619, 13284, 12719, 14553, "AABBQ", 400, 500, 550, 575, 600, 30, 40, 50, 60, 70, "TreasurePowerBuff", 1.5, { cardColor: 0.8, cardBuff: 12, fixedDamageBuff: 0, critialPowerBuff: 0 });
    initialServant(5,"Rider", "伊凡雷帝EN", "Иван Грозный", 205, [], "人", ["秩序", "恶"], [], 11619, 13284, 12719, 14553, "AABBQ", 300, 400, 450, 475, 500, 30, 40, 50, 60, 70, "TreasurePowerBuff", 1.5, { cardColor: 0.8, cardBuff: 12, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Rider", "玛丽・安托瓦内特EN", "Marie Antoinette", 29, [], "人", ["秩序", "善"], [], 8293, 12348, 10041, 14972, "AABQQ", 600, 800, 900, 950, 1000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: 0.8, cardBuff: 11, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Rider", "马大EN", "Marthe", 30, [], "人", ["秩序", "善"], [], 8014, 13068, 9703, 15845, "AAABQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: 0.8, cardBuff: 11.5, fixedDamageBuff: 150, critialPowerBuff: 0 });
    ...
    initialServant(3,"Rider", "美杜莎EN", "Medusa", 23, [], "地", ["混沌", "善"], [], 7200, 8937, 9744, 12117, "AABQQ", 600, 800, 900, 950, 1000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: 0.8, cardBuff: 11, fixedDamageBuff: 95, critialPowerBuff: 6 });
    ...
    initialServant(3,"Rider", "克里斯托弗·哥伦布EN", "Cristoforo Colombo", 172, [], "人", ["中立", "恶"], [], 6552, 9600, 8867, 13016, "AABBQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: 0.8, cardBuff: 8, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(2,"Rider", "爱德华・蒂奇EN", "Edward Teach", 25, [], "人", ["混沌", "恶"], [], 6188, 7907, 8967, 11411, "AABBQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
...
function initCaster(){
    ...
    initialServant(5,"Caster", "莱昂纳多・达・芬奇EN", "Leonardo da Vinci", 127, [], "星", ["混沌", "善"], [], 10598, 14259, 11601, 15621, "AAABQ", 450, 600, 675, 712.5, 750, 30, 40, 50, 60, 70, "TreasurePowerBuff", 1, { cardColor: 1, cardBuff: 10, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(3,"Caster", "库・丘林EN", "Cu Chulainn2", 38, [], "天",["秩序","中庸"],[], 6580, 9604, 8905, 13022, "AAABQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: 1, cardBuff: 8, fixedDamageBuff: 175, critialPowerBuff: 0 });
...
function initAss(){
    ...
    initialServant(5,"Assassin", "酒吞童子EN", "Shuten Doji", 112, [], "地",["混沌","恶"],[], 11993, 12825, 13128, 14050, "AABQQ", 450, 600, 675, 712.5, 750, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 150, critialPowerBuff: 0 });
    ...
    initialServant(5,"Assassin", "克利奥帕特拉EN", "Cleopatra", 139, [], "人",["秩序","中庸"],[], 11088, 13402, 12138, 14682, "ABBQQ", 300, 400, 450, 475, 500, 30, 40, 50, 60, 70, "TreasureSpecialCardPowerAttack", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 125, critialPowerBuff: 0 });
    ...
    initialServant(5,"Assassin", "賽米拉米斯EN", "Semiramis", 199, [], "地",["秩序","惡"],[], 11309, 13266, 12379, 14533, "AAABQ", 300, 400, 450, 475, 500, 10, 20, 30, 40, 50, "TreasurePowerBuff", 1.5, { cardColor: 1, cardBuff: 12, fixedDamageBuff: 150, critialPowerBuff: 0 });
    ...
    initialServant(4,"Assassin", "卡米拉EN", "Carmilla", 46, [], "地",["混沌","恶"],[], 9408, 10473, 11391, 12698, "ABQQQ", 600, 800, 900, 950, 1000, 120, 132.5, 145, 157.5, 170, "TreasureSpecialAttack", 1.5,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Assassin", "两仪式EN", "Ryougi Shiki（Assassin)", 92, [], "人",["混沌","善"],[], 8867, 11055, 10736, 13404, "AABQQ", 900, 1200, 1350, 1425, 1500, 0, 0, 0, 0, 0, "", 1, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 10 });
    ...
    initialServant(4,"Assassin", "武则天EN", "Wu Ze Tian", 170, [], "人",["秩序","恶"],[], 8981, 10942, 10874, 13267, "ABBQQ", 1200, 1600, 1800, 1900, 2000, 0, 0, 0, 0, 0, "", 0.8,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
...
function initBerserker(){
    ...
    initialServant(5,"Berserker", "土方岁三EN", "Hijikata Toshizou", 161, [], "人",["秩序","恶"],[], 12089, 12028, 13233, 13177, "ABBQQ", 600, 800, 900, 950, 1000, 600, 700, 800, 900, 1000, "TreasureSpecialRemainHpAttack", 1.5, { cardColor: 1.5, cardBuff: 5, fixedDamageBuff: 0, critialPowerBuff: 0 });
...
//----------------------------------Shielder---------------------------------------------------------------------//
    ...
    initialServant(4,"Ruler", "马大EN", "Marthe2", 135, [], "人",["秩序","善"],[], 9546, 11250, 11558, 13640, "ABBBQ", 600, 800, 900, 950, 1000, 10, 20, 30, 40, 50, "TreasureSpecialDefReduceAttck", 1.5,{ cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 0 });
    ...
    initialServant(4,"Avenger", "海森・罗伯EN", "Hyesons Robert", 158, [], "地",["混沌","恶"],[], 10628, 9949, 12868, 12063, "AABQQ", 1200, 1600, 1800, 1900, 2000, 0, 0, 0, 0, 0, "", 0.8, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 0, critialPowerBuff: 8 });
    /******************************************3星及以下********************************************************************/
    ...
    initialServant(4,"Alterego", "帕森莉普（热情迷唇）EN", "Passionlip", 164, [], "地",["秩序","中庸"],[], 10299, 10901, 12470, 13217, "ABBBQ", 300, 400, 450, 475, 500, 0, 0, 0, 0, 0, "", 1.5, { cardColor: -1, cardBuff: 0, fixedDamageBuff: 200, critialPowerBuff: 6 });
